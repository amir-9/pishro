    ...
    data: [
      {
        ...
        userCompany: null,
        rating: 5,
        text: "دوره عالی! من تونستم از چند ایردراپ درآمد خوبی کسب کنم. پشتیبانی هم عالی بود.",
        published: true,
        verified: true,
        featured: true,
        likes: [],
      ...
      },
      {
        ...
        rating: 5,
        text: "بهترین دوره ایردراپ که تا حالا دیدم. همه چیز خیلی ساده و عملی توضیح داده شده.",
        published: true,
        verified: true,
        featured: true,
        likes: [],
      ...
      },
      {
        ...
        userCompany: null,
        rating: 5,
        text: "بعد از این دوره، اولین NFT خودم رو ساختم و فروختم. واقعاً عالی بود!",
        published: true,
        verified: true,
        featured: true,
        likes: [],
