...
const CATEGORIES_DATA = [
  {
    ...
    title: "بورس و سهام",
    description:
      "آموزش جامع بورس، تحلیل سهام و استراتژی‌های سرمایه‌گذاری در بازار سرمایه",
    icon: "📈",
    color: "#3B82F6",
    coverImage: "https://picsum.photos/seed/cat-stock/1200/400",
    metaTitle: "آموزش بورس و سهام - راهنمای کامل سرمایه‌گذاری",
    metaDescription:
      "یادگیری تحلیل تکنیکال و بنیادی، استراتژی‌های نوسان‌گیری و سرمایه‌گذاری بلندمدت در بورس",
    ...
    heroDescription:
      "با آموزش‌های گام به گام، تحلیل‌های دقیق و استراتژی‌های عملی، مسیر موفقیت در بورس را هموار کنید.",
    ...
    aboutDescription:
      "بازار بورس یکی از بهترین راه‌های کسب درآمد پایدار و رشد سرمایه است. با آموزش اصولی و تمرین مداوم، می‌توانید به یک سرمایه‌گذار موفق تبدیل شوید.",
  ...
  },
  {
    ...
    title: "ارز دیجیتال",
    description:
      "آموزش کامل ارزهای دیجیتال، بلاکچین، بیت‌کوین و استراتژی‌های ترید کریپتو",
    icon: "₿",
    color: "#F59E0B",
    coverImage: "https://picsum.photos/seed/cat-crypto/1200/400",
    metaTitle: "آموزش ارز دیجیتال و کریپتوکارنسی - از مبتدی تا حرفه‌ای",
    metaDescription:
      "یادگیری خرید، فروش و معامله ارزهای دیجیتال، بلاکچین و تکنولوژی رمزارزها",
    metaKeywords: ["ارز دیجیتال", "بیت‌کوین", "اتریوم", "بلاکچین", "کریپتو"],
    heroTitle: "دنیای ارزهای دیجیتال",
    heroSubtitle: "سرمایه‌گذاری در آینده",
    heroDescription:
      "با آموزش تخصصی کریپتوکارنسی، وارد دنیای هیجان‌انگیز ارزهای دیجیتال شوید و در انقلاب مالی نوین شرکت کنید.",
    ...
    aboutDescription:
      "ارزهای دیجیتال در حال تغییر چهره اقتصاد جهانی هستند. با یادگیری این تکنولوژی، می‌توانید از فرصت‌های بی‌نظیر سرمایه‌گذاری بهره‌مند شوید.",
  ...
  },
  {
    ...
    title: "فارکس",
    description:
      "آموزش معامله در بازار فارکس، جفت ارزها و استراتژی‌های معاملاتی",
    icon: "💱",
    color: "#10B981",
    coverImage: "https://picsum.photos/seed/cat-forex/1200/400",
    metaTitle: "آموزش فارکس - معامله‌گری در بازار ارز",
    metaDescription:
      "یادگیری تحلیل و معامله در بازار جهانی ارز (Forex) با استراتژی‌های حرفه‌ای",
    ...
    heroDescription:
      "فارکس بزرگترین و نقدشونده‌ترین بازار مالی جهان است. با آموزش تخصصی، مهارت‌های لازم برای موفقیت را کسب کنید.",
    ...
    aboutDescription:
      "با حجم معاملات روزانه بیش از 6 تریلیون دلار، فارکس فرصت‌های فراوانی برای معامله‌گران فراهم می‌کند.",
  ...
  },
  {
    ...
    title: "تحلیل تکنیکال",
    description:
      "آموزش کامل تحلیل تکنیکال، اندیکاتورها، الگوهای قیمت و نمودارها",
    icon: "📊",
    color: "#8B5CF6",
    coverImage: "https://picsum.photos/seed/cat-technical/1200/400",
    metaTitle: "آموزش تحلیل تکنیکال - راهنمای جامع",
    metaDescription:
      "یادگیری تحلیل نمودار، اندیکاتورها، الگوهای کندلی و استراتژی‌های تحلیل تکنیکال",
    metaKeywords: ["تحلیل تکنیکال", "اندیکاتور", "کندل استیک", "نمودار"],
    heroTitle: "هنر پیش‌بینی بازار",
    heroSubtitle: "تحلیل تکنیکال حرفه‌ای",
    heroDescription:
      "با تسلط بر تحلیل تکنیکال، می‌توانید روند بازار را پیش‌بینی کرده و تصمیمات معاملاتی بهتری بگیرید.",
    ...
    aboutDescription:
      "تحلیل تکنیکال مهم‌ترین ابزار هر معامله‌گر است. الگوها، اندیکاتورها و سطوح حمایت و مقاومت را بشناسید.",
  ...
  },
  {
    ...
    metaDescription:
      "یادگیری تحلیل صورت‌های مالی، نسبت‌های مالی و ارزیابی ارزش ذاتی سهام",
    ...
    heroDescription:
      "با تحلیل بنیادی، ارزش واقعی شرکت‌ها را بشناسید و سرمایه‌گذاری‌های بلندمدت و سودآور انجام دهید.",
    ...
    aboutDescription:
      "تحلیل بنیادی به شما کمک می‌کند تا شرکت‌های ارزشمند را شناسایی کرده و سرمایه‌گذاری‌های بلندمدت موفق داشته باشید.",
  ...
  },
  {
    ...
    metaDescription:
      "یادگیری اصول مدیریت ریسک، تعیین حد ضرر و سود، و استراتژی‌های کنترل ریسک",
    metaKeywords: ["مدیریت ریسک", "حد ضرر", "مدیریت سرمایه", "کنترل ریسک"],
    heroTitle: "حفاظت از سرمایه شما",
    heroSubtitle: "مدیریت حرفه‌ای ریسک",
    heroDescription:
      "بدون مدیریت ریسک، هیچ استراتژی معاملاتی موفق نخواهد بود. یاد بگیرید چگونه سرمایه خود را محافظت کنید.",
    ...
    aboutDescription:
      "مدیریت صحیح ریسک می‌تواند تفاوت بین موفقیت و شکست در بازارهای مالی باشد. این مهارت را فرا بگیرید.",
  ...
  },
  {
    ...
    metaDescription:
      "یادگیری کنترل ترس و طمع، مدیریت استرس معاملاتی و تقویت ذهنیت موفق",
    metaKeywords: ["روانشناسی معامله‌گری", "کنترل احساسات", "استرس", "ذهنیت"],
    heroTitle: "قدرت ذهن",
    heroSubtitle: "روانشناسی موفقیت در بازار",
    heroDescription:
      "80% موفقیت در معامله‌گری مربوط به روانشناسی است. یاد بگیرید چگونه ذهن خود را کنترل کنید.",
    ...
    aboutDescription:
      "بسیاری از معامله‌گران با وجود دانش فنی، به دلیل ضعف روانی شکست می‌خورند. این مهارت حیاتی را فرا بگیرید.",
  ...
  },
  {
    ...
    aboutTitle2: "سرمایه‌گذاری علمی",
    aboutDescription:
      "سرمایه‌گذاری صحیح نیازمند دانش، صبر و برنامه‌ریزی است. با استراتژی‌های مناسب، به اهداف مالی خود برسید.",
