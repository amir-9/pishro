...
export const stepsData = [
  {
    ...
    description:
      "در این مرحله با اصول اولیه مالی، مدیریت بودجه شخصی و مفهوم سرمایه‌گذاری آشنا می‌شوید. همچنین شناخت ریسک و بازده برای ورود به مباحث تخصصی‌تر پایه‌ریزی می‌شود.",
  },
  {
    id: 2,
