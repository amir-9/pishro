...
export const metaverseSectionData = [
  {
    title: "در اینجا یک شعار یا جمله به عنوان تایتل بنویسید",
    description:
      "لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در شصت و ",
...
export const aboutPishro = {
  header: "درباره پیشرو",
  title: "پیشرو از چه افرادی تشکیل شده و چگونه فعالیت میکند؟",
  description:
    "در اینجا یک توصیف کلی درباره برند انجام میدهیم و باقی تمرکز رو بر معرفی دپارتمان ها میذاریم و سعی میکنیم در یه بخش کلی به دپارتمانها نگاهی داشته باشیم، لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.",
  image: "/images/about/about.webp",
};

export const pishroBranding = {
  header: "برندینگ پیشرو",
  title: "هویت سازی بسود چگونه شکل گرفته است؟",
  description:
    "از این محیط برای بیان نتایج دیجیتال مارکتینگ و مراحل طراحی لوگو و برندینگ بسود استفاده میکنیم، طبیعتاً نیاز به تصویری از تیم دیجیتال مارکتینگ داریم که به برندبوک لوگو اشاره دارد تا در این بخش نمایش داده شود و همچنین دیتای این بخش باید در همین سکشن تکمیل شود و در نتیجه به حداقل شش خط و حداکثر هشت خط محتوا نیاز داریم که باید به صورت توصیفی به کاربر اطلاعات داده شود و نه تخصصی.",
