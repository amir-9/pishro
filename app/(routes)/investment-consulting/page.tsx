...
const InvestmentPage = () => {
  return (
    <div className="container flex flex-col lg:flex-row justify-between gap-8 py-20">
      {/* Text & Actions */}
      ...
      <div className="flex-1 relative flex items-center justify-center mt-12 lg:mt-0">
        <div className="relative w-full h-[500px] overflow-hidden isolate rounded-xl">
          <div className="absolute inset-y-0 left-0 w-[150px] bg-[linear-gradient(to_right,_#fefefe_50%,_transparent_100%)] z-10 pointer-events-none" />
          <div className="absolute inset-y-0 right-0 w-[150px] bg-[linear-gradient(to_left,_#fefefe_50%,_transparent_100%)] z-10 pointer-events-none" />
          <Image
